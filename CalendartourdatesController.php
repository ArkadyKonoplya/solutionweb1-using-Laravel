...
use App\Models\Calendartourdates;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ;

class CalendartourdatesController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();
	public $module = 'calendartourdates';
	static $per_page	= '10';

	public function __construct()
	{
		parent::__construct();
		$this->model = new Calendartourdates();
		...
		$this->data = array(
			...
			'pageModule'		=> 'calendartourdates',
			'pageUrl'			=>  url('calendartourdates'),
	...
	public function getIndex()
	{
		...
		return view('calendartourdates.index',$this->data);
	}
	...
	public function postData( Request $request)
	{
		...
		$pagination->setPath('calendartourdates/data');
		...
		return view('calendartourdates.table',$this->data);
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		return view('calendartourdates.form',$this->data);
	}
	...
	public function getShow( Request $request , $id = null)
	{
		...
		if($row)
		{
			...
			if($print =='true')
			{
				$data['html'] = view('calendartourdates.view', $this->data)->render();
				return view('layouts.blank',$data);
			} else {
				return view('calendartourdates.view',$this->data);
			}
	...
	public static function display( )
	{
		...
		$model  = new Calendartourdates();
		$info = $model::makeInfo('calendartourdates');
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('calendartourdates.public.view',$data);
			}
			...
			return view('calendartourdates.public.index',$data);
		}
